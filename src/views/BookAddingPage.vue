  ...
  <div class="container" style="padding: 80px 0;">
    <div class="row px-4">
      <div class="col-sm-6 col-xs-12">
        <h1 class="text-start">Book Adding</h1>
      </div>
    ...
    <div class="row my-3">
      <BookForm class="col-4" v-model:book_prop.sync="book" :authors="authors" @submit.prevent="saveBook(book); this.$router.push('/books')"/>
